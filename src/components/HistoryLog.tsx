...
export function HistoryLog({ history, isOpen, onToggle }: HistoryLogProps) {
  return (
    <section className="min-h-0 animate-fade-up overflow-hidden rounded-xl border border-stone-200/8 bg-black/35 backdrop-blur-xl [animation-delay:100ms] [animation-fill-mode:both]">
      ...
      {isOpen && (
        <div className="max-h-72 space-y-2.5 overflow-y-auto border-t border-stone-200/8 px-4 py-3 scrollbar-thin lg:max-h-full">
          {history.length === 0 ? (
